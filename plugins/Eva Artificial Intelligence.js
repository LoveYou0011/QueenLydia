...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to QueenLydia voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel QueenLydia özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'QueenLydia yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'QueenLydia yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'QueenLydia, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'QueenLydia, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Lydia features. Turn your account into a ai chatbot!'
    already_on = 'Lydia artificial intelligence is already fully functional.'
    already_off = 'Lydia artificial intelligence is currently running semi-functional.'
    succ_on = 'Lydia Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Lydia Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
