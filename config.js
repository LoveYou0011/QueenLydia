...
module.exports = {
    ...
    SESSION: process.env.ASENA_SESSION === undefined ? '' : process.env.LYDIA_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By QueenLydia' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'QueenLydia Bot' : process.env.BOT_NAME,
